...
<span class="token function">make</span>  x86_64_defconfig 
<span class="token comment"># 如果想要更好的clangd补全就用clang编译(make CC=clang x86_64_defconfig ) ，但是clang在部分模块可能需要特殊的编译选</span>
<span class="token comment"># 项才能编译，所以还是推荐用默认的gcc编译，尽管</span>
<span class="token comment"># 这样clangd的效果会差一点</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,19);function u(m,v){const a=i("ExternalLinkIcon");return l(),o("div",null,[n("p",null,[s("参考于"),n("a",d,[s("QEMU调试Linux内核环境搭建"),c(a)])]),p])}const h=e(r,[["render",u],["__file","vscode qemu开发Linux内核.html.vue"]]);export{h as default};
