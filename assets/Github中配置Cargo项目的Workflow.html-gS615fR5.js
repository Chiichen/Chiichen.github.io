import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as t,o as c,c as l,a as n,b as s,d as p,e as i}from"./app-3RJ8DJ0f.js";const o={},u=n("h2",{id:"项目背景",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#项目背景","aria-hidden":"true"},"#"),s(" 项目背景")],-1),r={href:"https://github.com/RccCommunity/rcc",target:"_blank",rel:"noopener noreferrer"},k=i(`<h2 id="示例" tabindex="-1"><a class="header-anchor" href="#示例" aria-hidden="true">#</a> 示例</h2><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">name</span><span class="token punctuation">:</span> Rust
