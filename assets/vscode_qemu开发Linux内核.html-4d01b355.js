import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o as l,c as o,a as n,b as s,d as r,e as t}from"./app-38316a56.js";const c={},d={href:"http://kerneltravel.net/blog/2021/debug_kernel_szp/",target:"_blank",rel:"noopener noreferrer"},p=t(`<h2 id="获取linux源码" tabindex="-1"><a class="header-anchor" href="#获取linux源码" aria-hidden="true">#</a> 获取Linux源码</h2><ul><li>略</li></ul><h2 id="编译linux内核" tabindex="-1"><a class="header-anchor" href="#编译linux内核" aria-hidden="true">#</a> 编译Linux内核</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">cd</span> /linux
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="编译" tabindex="-1"><a class="header-anchor" href="#编译" aria-hidden="true">#</a> 编译</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#编译，并用来获取 compile_commands.json 文件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,19);function u(b,v){const a=i("ExternalLinkIcon");return l(),o("div",null,[n("p",null,[s("参考于"),n("a",d,[s("QEMU调试Linux内核环境搭建"),r(a)])]),p])}const h=e(c,[["render",u],["__file","vscode_qemu开发Linux内核.html.vue"]]);export{h as default};
