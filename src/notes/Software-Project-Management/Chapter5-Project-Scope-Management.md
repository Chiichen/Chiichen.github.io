...
- 项目范围管理(project scope management)是指界定和控制项目中应包括什么和不包括什么所涉及的过程。该过程确保了项目团队和干系人对项目的可交付成果以及生产这些可交付成果所进行的工作达成共识。项目范围管理包含6个主要过程:
...
:::info 需求开发
对于软件项目而言,将需求开发划分为获取、分析、规范与确认4个软件工程步骤会很有帮助。这些步骤包括为软件或包含软件的产品收集、评估和记录需求所涉及的所有活动。
:::
...
- 即使界定了项目范围,许多IT项目还是会遭遇`范围蔓延(scope creep)`——项目范围有不断扩大的趋势。
